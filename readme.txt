=== Social Publisher ===
Contributors: maller
Tags: linkedin, auto-publish, social media, ACF, content recycling
...
Auto-publish your WordPress posts on LinkedIn – with custom text, images, and content recycling. For B2B, agency workflow, or personal usage.

== Description ==

Social Publisher is a GDPR-compliant WordPress plugin for automatic posting on LinkedIn – directly when publishing a post. It is ideal for content recycling, evergreen publishing, and B2B workflows used by agencies, editorial teams, and marketing professionals.
...
* Recycle your best content automatically – ideal for evergreen articles and periodic reposting
...
= 1.5.0 =
* Codebase fully refactored for WordPress.org compliance
* Consistent prefixing of all functions, options, actions, and AJAX calls using "socipu_"
* Improved security: replaced all wp_redirect() calls with wp_safe_redirect()
* Removed closing PHP tag to prevent header errors
* Moved screenshots to SVN /assets folder
* Added missing plugin header fields for compatibility declaration
