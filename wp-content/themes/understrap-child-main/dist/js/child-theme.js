...
(function (global, factory) {
	...
	*/
	...
	jQuery(document).on("click", ".filter li span", function (e) {
	  ...
	  var url = form.attr("action"); // Set the value of the format taxonomy filter

	  var filterValue = jQuery(this).data("filter-value");
	  var filters = "_sft_portfolio_format_taxonomy=" + filterValue; // Add any additional filter parameters to the URL
	...
	logos.forEach(element => {
	  ...
	  gsap.to(contents, {
	    ...
	    scrollTrigger: {
	      ...
	      end: "bottom top+=100" //toggleActions: "play reverse play reverse"
	...
	new Swiper(".page-template-page-sea .swiper", {
	  loop: true,
	  spaceBetween: 10,
	  freeMode: false,
	  slidesPerView: 1,
	...
	new Swiper(".post-template-post-sea-linkedin #container-epsilon .swiper", {
	  loop: false,
	  autoplay: false,
	  spaceBetween: 50,
	  freeMode: false,
	...
	document.querySelector("#wrapper-navbar .navbar");
	document.querySelector("#wrapper-navbar .container-fluid");
